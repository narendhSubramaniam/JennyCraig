...
extension JCLoginSignUpContainerController: AWSCognitoIdentityPasswordAuthentication {
    ...
    public func getDetails(_ authenticationInput: AWSCognitoIdentityPasswordAuthenticationInput, passwordAuthenticationCompletionSource: AWSTaskCompletionSource<AWSCognitoIdentityPasswordAuthenticationDetails>) {
        ...
        if let nav =  self.childViewControllers.last as? UINavigationController {

            if let accountInfoController =  (nav.childViewControllers.last as? JCAccountInfoController) {
